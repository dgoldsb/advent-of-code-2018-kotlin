...
object Day19 : Day<Pair<Int, List<OpcodeInstruction>>>(19) {
  ...
  override fun part2(input: Pair<Int, List<OpcodeInstruction>>): String {
    // TODO: There seems to be a cycle from instruction 3-4. Will leave this for now, my main goal
    //  is writing a lot of Kotlin :)
    return OpcodeExecuter(RegisterState(listOf(1, 0, 0, 0, 0, 0)), input.first)
        .execute(input.second)
        .get(0)
        .toString()
  }
